                                      ...
                                      EG_StringHash type)
{
	...
	/* Set callbacks.
	 */
	EG_Widget_SetCallback_Destroy(widget_ptr, Callback_Destroy);

	EG_Widget_SetCallback_Paint(widget_ptr, Callback_Paint);
	EG_Widget_SetCallback_SDL_Event(widget_ptr, Callback_SDL_Event);
	EG_Widget_SetCallback_Visible(widget_ptr, Callback_Visible);
	EG_Widget_SetCallback_Enabled(widget_ptr, Callback_Enabled);
	EG_Widget_SetCallback_GotFocus(widget_ptr, Callback_GotFocus);
	EG_Widget_SetCallback_LostFocus(widget_ptr, Callback_LostFocus);
	EG_Widget_SetCallback_Stopped(widget_ptr, Callback_Stopped);
	EG_Widget_SetCallback_Attach(widget_ptr, Callback_Attach);

	EG_Widget_SetUserCallback_OnChange(widget_ptr, NULL, NULL);
	EG_Widget_SetUserCallback_OnClick(widget_ptr, NULL, NULL);
	EG_Widget_SetUserCallback_OnEvent(widget_ptr, NULL, NULL);
	EG_Widget_SetUserCallback_OnLostFocus(widget_ptr, NULL, NULL);
	EG_Widget_SetUserCallback_OnGotFocus(widget_ptr, NULL, NULL);
...
void EG_Widget_CallDestroy(EG_Widget *widget_ptr)
{
	...
	{
		EG_Log(EG_LOG_ERROR, dL"EG_Widget.func_destroy_ptr = NULL, widget not freed!", dR);
	}
	else
	{
		func_ptr = widget_ptr->func_destroy_ptr;
...
EG_BOOL EG_Widget_CallPaint(EG_Widget *widget_ptr, SDL_Rect rect)
{
	...
	{
		func_ptr = widget_ptr->func_paint_ptr;
...
EG_BOOL EG_Widget_CallSDLEvent(EG_Widget *widget_ptr, SDL_Event *event_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_sdl_event_ptr;
...
EG_BOOL EG_Widget_CallVisible(EG_Widget *widget_ptr, EG_BOOL visible)
{
	...
	{
		func_ptr = widget_ptr->func_visible_ptr;
...
EG_BOOL EG_Widget_CallEnabled(EG_Widget *widget_ptr, EG_BOOL enabled)
{
	...
	{
		func_ptr = widget_ptr->func_enabled_ptr;
...
EG_BOOL EG_Widget_CallGotFocus(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_got_focus_ptr;
...
void EG_Widget_CallLostFocus(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_lost_focus_ptr;
...
EG_BOOL EG_Widget_CallStopped(EG_Widget *widget_ptr, EG_BOOL stopped)
{
	...
	{
		func_ptr = widget_ptr->func_stopped_ptr;
...
void EG_Widget_CallAttach(EG_Widget *widget_ptr,
                          EG_StringHash attach_to_type,
                          void *attach_to_ptr,
                          EG_BOOL attached)
{
	...
	{
		func_ptr = widget_ptr->func_attach_ptr;
...
void EG_Widget_CallUserOnChange(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_user_change_ptr;
...
void EG_Widget_CallUserOnClick(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_user_click_ptr;
...
void EG_Widget_CallUserOnEvent(EG_Widget *widget_ptr, SDL_Event *event_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_user_event_ptr;
...
void EG_Widget_CallUserOnLostFocus(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_user_lostfocus_ptr;
...
void EG_Widget_CallUserOnGotFocus(EG_Widget *widget_ptr)
{
	...
	{
		func_ptr = widget_ptr->func_user_gotfocus_ptr;
                                    ...
                                    EG_Callback_Paint paint_func_ptr)
{
	...
	widget_ptr->func_paint_ptr = paint_func_ptr;
                                        ...
                                        EG_Callback_SDL_Event sdl_event_func_ptr)
{
	...
	widget_ptr->func_sdl_event_ptr = sdl_event_func_ptr;
                                      ...
                                      EG_Callback_Visible visible_func_ptr)
{
	...
	widget_ptr->func_visible_ptr = visible_func_ptr;
                                      ...
                                      EG_Callback_Enabled enabled_func_ptr)
{
	...
	widget_ptr->func_enabled_ptr = enabled_func_ptr;
                                       ...
                                       EG_Callback_GotFocus got_focus_func_ptr)
{
	...
	widget_ptr->func_got_focus_ptr = got_focus_func_ptr;
                                        ...
                                        EG_Callback_LostFocus lost_focus_func_ptr)
{
	...
	widget_ptr->func_lost_focus_ptr = lost_focus_func_ptr;
                                      ...
                                      EG_Callback_Destroy destroy_func_ptr)
{
	...
	widget_ptr->func_destroy_ptr = destroy_func_ptr;
                                      ...
                                      EG_Callback_Stopped stopped_func_ptr)
{
	...
	widget_ptr->func_stopped_ptr = stopped_func_ptr;
                                     ...
                                     EG_Callback_Attach attach_func_ptr)
{
	...
	widget_ptr->func_attach_ptr = attach_func_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnChange(EG_Widget *widget_ptr,
                                           EG_Callback_User_OnChange user_callback_ptr,
                                           void *user_change_value_ptr)
{
	CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);

	widget_ptr->func_user_change_ptr = user_callback_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnClick(EG_Widget *widget_ptr,
                                          EG_Callback_User_OnClick user_callback_ptr,
                                          void *user_click_value_ptr)
{
	CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);

	widget_ptr->func_user_click_ptr = user_callback_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnEvent(EG_Widget *widget_ptr,
                                          EG_Callback_User_OnEvent user_callback_ptr,
                                          void *user_event_value_ptr)
{
	CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);

	widget_ptr->func_user_event_ptr = user_callback_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnLostFocus(EG_Widget *widget_ptr,
                                              EG_Callback_User_OnLostFocus user_callback_ptr,
                                              void *user_event_value_ptr)
{
	CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);

	widget_ptr->func_user_lostfocus_ptr = user_callback_ptr;
...
EG_BOOL EG_Widget_SetUserCallback_OnGotFocus(EG_Widget *widget_ptr,
                                             EG_Callback_User_OnGotFocus user_callback_ptr,
                                             void *user_event_value_ptr)
{
	CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);

	widget_ptr->func_user_gotfocus_ptr = user_callback_ptr;
